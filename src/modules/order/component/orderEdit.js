...
class Index extends React.Component {
    ...
    handleOk = () => {
        ...
        tempSelectedRow = uniqBy(tempSelectedRow, 'id');
        tempSelectedRow = tempSelectedRow.filter(item => includes(tempSelectedRowKeys, item.id));
    ...
    onSelectChange = (selectedRowKeys, selectedRows) => {
        ...
        console.log('selectedRows changed', this.state.tempSelectedRow);
