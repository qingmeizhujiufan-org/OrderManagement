...
import {Icon, Divider, Breadcrumb, Spin, Button, Message, Dropdown, Menu, Switch, Row, Col, Input} from 'antd';
...
class Index extends React.Component {
    ...
    render() {
        const {searchText, dataSource, loading, delLoading} = this.state;
